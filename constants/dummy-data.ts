...
export const DUMMY_PRODUCTS: DummyProduct[] = [
    {
        ...
        slug: { current: "shadow-oversized-tee", _type: "slug" },
        price: 3500,
        discount: 10,
        stock: 25,
        status: "new",
        variantInfo: "Black / M-XL",
        rating: 4.8,
        isBestSelling: true,
        isTopRated: true,
        salesCount: 120,
        images: [
            { _key: "img-1a", _type: "image", url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&q=80" },
            { _key: "img-1b", _type: "image", url: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=800&q=80" },
        ],
        description: [{ _type: "block", _key: "d1", children: [{ _type: "span", _key: "s1", text: "Premium heavyweight oversized tee crafted from 100% organic cotton. Features a relaxed drop-shoulder fit with ribbed crew neck. The perfect foundation for any streetwear look." }] }],
    },
    {
        _id: "prod-2",
        _type: "product",
        ...
        slug: { current: "midnight-cargo-pants", _type: "slug" },
        price: 5800,
        discount: 0,
        stock: 18,
        status: "new",
        variantInfo: "Black / 30-36",
        rating: 4.9,
        isBestSelling: true,
        isTopRated: true,
        salesCount: 95,
        images: [
            { _key: "img-2a", _type: "image", url: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800&q=80" },
            { _key: "img-2b", _type: "image", url: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&q=80" },
        ],
        description: [{ _type: "block", _key: "d2", children: [{ _type: "span", _key: "s2", text: "Technical cargo pants with a tapered silhouette. Features six utility pockets, adjustable waist tabs, and elastic ankle cuffs. Built for urban movement." }] }],
    },
    {
        _id: "prod-3",
        _type: "product",
        ...
        slug: { current: "raw-edge-denim-jacket", _type: "slug" },
        price: 7200,
        discount: 15,
        stock: 12,
        status: "new",
        variantInfo: "Washed Black / S-XL",
        rating: 4.7,
        isBestSelling: false,
        isTopRated: true,
        salesCount: 65,
        images: [
            { _key: "img-3a", _type: "image", url: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&q=80" },
            { _key: "img-3b", _type: "image", url: "https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=800&q=80" },
        ],
        description: [{ _type: "block", _key: "d3", children: [{ _type: "span", _key: "s3", text: "Deconstructed denim jacket with raw-cut hem and distressed detailing. 14oz Japanese selvedge denim with a slim, modern fit. Ages beautifully over time." }] }],
    },
    {
        _id: "prod-4",
        _type: "product",
        ...
        slug: { current: "phantom-slim-jeans", _type: "slug" },
        price: 4900,
        discount: 0,
        stock: 30,
        status: "hot",
        variantInfo: "Onyx / 28-36",
        rating: 4.6,
        isBestSelling: true,
        isTopRated: false,
        salesCount: 150,
        images: [
            { _key: "img-4a", _type: "image", url: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=800&q=80" },
            { _key: "img-4b", _type: "image", url: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=800&q=80" },
        ],
        description: [{ _type: "block", _key: "d4", children: [{ _type: "span", _key: "s4", text: "High-stretch slim jeans in deep onyx wash. Features a modern mid-rise with tapered leg. Made with comfort-flex denim for all-day wear." }] }],
    },
    {
        _id: "prod-5",
        _type: "product",
