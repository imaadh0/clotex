                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-3 px-6 py-3 bg-neutral-900 border border-neutral-800 rounded-full hover:border-white transition-all duration-300 min-w-[200px] justify-between text-white"
                        >
                        ...
                        {/* Dropdown Menu */}
                        {isDropdownOpen && (
                            <div className="absolute top-full right-0 mt-2 w-full bg-neutral-900 rounded-2xl shadow-xl border border-neutral-800 p-2 z-50 text-white">
                                <button
                                    onClick={() => {
