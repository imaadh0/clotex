                            ...
                            >
                                <div className="relative w-full h-full min-h-[240px]">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                                        ...
                                        {bottomRight.ctaText && (
                                            <span className="inline-flex items-center gap-2 px-5 py-2 bg-white text-black hover:bg-neutral-200 rounded-full text-xs font-bold uppercase tracking-wider transition-colors">
                                                {bottomRight.ctaText}
                                            </span>
                                        )}
                                    </div>
